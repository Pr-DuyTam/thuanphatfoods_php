...
*/
    ...
    // case "search":
    //     $mathang = $mh->timkiemmathang($_POST["search"]);
    //     include("main.php");
    //     break;
case "search":
    $mathang = $mh->timkiemmathang($_POST["search"]);
    ...
    if (empty($mathang)) {
        $thongbao = "<p>Không tìm thấy sản phẩm nào.</p>";
        $mathang = []; // Đảm bảo không hiển thị danh mục nào
    } else {
        $thongbao = ""; // Không hiển thị thông báo nếu có kết quả
    }
